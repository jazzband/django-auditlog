...
from auditlog_tests.models import SimpleModel, AltPrimaryKeyModel, UUIDPrimaryKeyModel, \
    ...
    ManyRelatedModel, FirstManyRelatedModel, OtherManyRelatedModel, AdditionalDataIncludedModel, \
    DateTimeFieldModel, ChoicesFieldModel, CharfieldTextfieldModel, PostgresArrayFieldModel, \
