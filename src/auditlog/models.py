...
class LogEntry(models.Model):
    ...
    content_type = models.ForeignKey('contenttypes.ContentType', models.CASCADE, related_name='+', verbose_name=_("content type"))
    ...
    actor = models.ForeignKey(settings.AUTH_USER_MODEL, models.SET_NULL, blank=True, null=True, related_name='+', verbose_name=_("actor"))
